...
@section('title', 'Tambah Siswa - SMA PGRI Pelaihari')
...
<div class="mb-8 animate-slide-in">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">Tambah Siswa</h1>
            <p class="text-white/80 mt-1">Isi form berikut untuk menambahkan data siswa baru</p>
        </div>
...
<div class="glass-card rounded-2xl p-8 animate-slide-in delay-1">
    <form action="{{ route('bendahara.siswa.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir" class="form-input" 
                           value="{{ old('tempat_lahir') }}" placeholder="Contoh: Banjarmasin">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="no_telp" class="form-input" 
                           value="{{ old('no_telp') }}" placeholder="081234567890">
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <textarea name="alamat" rows="3" class="form-input" placeholder="Masukkan alamat lengkap">{{ old('alamat') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="profile-avatar w-16 h-16 bg-gray-200" id="preview-container" style="display: none;">
                            <img id="foto-preview" src="" alt="Preview" class="w-full h-full object-cover rounded-xl">
                        </div>
                        <div class="flex-1">
        ...
        <div class="mb-8">
            <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
                <i class="fas fa-cog text-[#0b4f8c] mr-2"></i>
                Opsi Tambahan
            </h3>
            
            <div class="flex items-center space-x-2">
                <input type="checkbox" name="create_user" id="create_user" value="1" class="rounded border-gray-300 text-[#0b4f8c] focus:ring-[#0b4f8c]" {{ old('create_user') ? 'checked' : '' }}>
                <label for="create_user" class="text-sm text-gray-700">
                    Buatkan akun login untuk siswa (Password default = NIS)
                </label>
            </div>
        </div>
