...
@section('title', 'Data Tahun Ajaran - Bendahara SMA PGRI Pelaihari')
...
<div class="mb-8 animate-slide-in">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-white/80 mt-1">Kelola data tahun ajaran dan semester (Bendahara)</p>
        </div>
...
<div class="modal-overlay" id="createModal" style="display: none;">
    <div class="modal-content max-w-lg">
        ...
        <form action="{{ route('bendahara.tahun-ajaran.store') }}" method="POST" id="createForm">
            @csrf
